...
function inputSubmit(el) { //extend Buttons
	...
	el.left.src = "../servlet/Tool?images/efemerides/0.png";
	el.right = document.createElement('img');
	el.right.src = "../servlet/Tool?images/efemerides/0.png";
...
function textarea(el) { //extend Textareas
	...
	el.topLeft.src = "../servlet/Tool?images/efemerides/0.png";
	el.topLeft.className = "NFTextareaTopLeft";
	el.topRight = document.createElement('div');
	el.topRight.className = "NFTextareaTop";
	el.bottomLeft = document.createElement('img');
	el.bottomLeft.src = "../servlet/Tool?images/efemerides/0.png";
