...
function Menu(label) {
    ...
    this.childMenuIcon = "../servlet/Tool?images/arrows.gif";
    this.childMenuIconHilite = "../servlet/Tool?images/arrows2.gif";
...
function writeMenus(container) {
    ...
    for (var i=0; i<container.menus.length; i++, countMenus++) {
        ...
        content += ''+
        '<DIV ID="menuLayer'+ countMenus +'" STYLE="z-index:200;position:absolute;left:10;top:'+ (i * 100) +';visibility:hidden;">\n'+
        '  <DIV ID="menuLite'+ countMenus +'" STYLE="z-index:200;position:absolute;left:'+ proto.menuBorder +';top:'+ proto.menuBorder +';visibility:hide;" onMouseOut="hideMenu(this);">\n'+
        '    <DIV ID="menuFg'+ countMenus +'" STYLE="z-index:200;position:absolute;left:1;top:1;visibility:hide;">\n'+
        '';
        var x=i;
        for (var i=0; i<menu.items.length; i++) {
            ...
            var itemProps = 'z-index:200;visibility:hide;font-Family:' + proto.fontFamily +';font-Weight:' + proto.fontWeight + ';fontSize:' + proto.fontSize + ';';
            if (document.all) 
            ...
            var dTag    = '<DIV ID="menuItem'+ countItems +'" STYLE="z-index:200;position:absolute;left:0;top:'+ (i * proto.menuItemHeight) +';'+ itemProps +'">';
            var dText   = '<DIV ID="menuItemText'+ countItems +'" STYLE="z-index:200;position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColor +';">'+ item +'</DIV>\n<DIV ID="menuItemHilite'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColorHilite +';visibility:hidden;">'+ item +'</DIV>';
            if (item == "separator") {
                content += ( dTag + '<DIV ID="menuSeparator'+ countItems +'" STYLE="z-index:200;position:absolute;left:1;top:2;"></DIV>\n<DIV ID="menuSeparatorLite'+ countItems +'" STYLE="position:absolute;left:1;top:2;"></DIV>\n</DIV>');
            } else if (childMenu) {
                content += ( dTag + dText + '<DIV ID="childMenu'+ countItems +'" STYLE="z-index:200;position:absolute;left:0;top:3;'+ itemProps +'"><IMG SRC="'+ proto.childMenuIcon +'"></DIV>\n</DIV>');
            } else {
                content += ( dTag + dText + '</DIV>');
            }
            countItems++;
        }
        content += '      <DIV ID="focusItem'+ countMenus +'" STYLE="z-index:200;position:absolute;left:0;top:0;visibility:hide;" onClick="onMenuItemAction(null,this);">&nbsp;</DIV>\n';
        content += '   </DIV>\n  </DIV>\n</DIV>\n';
        i=x;
    }
    if (!container) return;
    ...
    if (container.document.layers) {
        ...
        for (var x=0; x<container.menus.length; x++) {
            ...
            //*********Asigna ancho del item del menu
            proto.menuItemWidth = proto.menuItemWidth || 100;
            ...
            for (var i=0; i<container.menus[x].items.length; i++) {
                ...
                if (childItem) {
                    ...
                    childItem.style.pixelWidth = 40 || 7;
...
function hideChildMenu(menuLayer) {
    ...
    if (l.childMenu) {
        if (document.layers) {
            ...
            l.Menu.container.clip.width += l.childMenu.clip.width +200;
