...
cellColor        = "fffce1";     // TABLE CELL BG COLOR OF THE DATE CELLS IN THE BOTTOM FRAME
headingCellColor = "#CC0000";         // TABLE CELL BG COLOR OF THE WEEKDAY ABBREVIATIONS
...
hoverColor       = "#CC0000";       // TEXT COLOR OF A LINK WHEN YOU HOVER OVER IT
...
/*if (isNav)
	...
	selectedLanguage = navigator.browserLanguage;*/
...
function setDateField(dateField, dateField_2) {

    // ASSIGN THE INCOMING FIELD OBJECT TO A GLOBAL VARIABLE
    calDateField = dateField;
	calDateField_2 = dateField_2;
...
//        "<BODY BGCOLOR='" + topBackground + "' background='/vacaciones/imagen/fondo_open.jpg' text='#000000' topmargin='0' marginheight='0' leftmargin='0' marginwidth='0'>" +
        "<BODY BGCOLOR='" + topBackground + "' text='#000000' topmargin='0' marginheight='0' leftmargin='0' marginwidth='0'>" +
//        "<link rel='stylesheet' href='/vacaciones/style/fuente.css' type='text/css'>"+
        ...
        "<CENTER>" +
        getMonthSelect() +
        "<INPUT NAME='year' class='cajatexto' VALUE='" + calDate.getFullYear() + "'TYPE=TEXT SIZE=4 MAXLENGTH=4 onChange='parent.opener.setYear()'>" +
        "</CENTER>" +
        "</TD>" +
        "</TR>" +
        "<TR>" +
...
function getMonthSelect() {
    ...
    monthSelect = "<SELECT NAME='month' class='cajatexto' onChange='parent.opener.setCurrentMonth()'>";
...
function returnDate(inDay){
    ...
    calDateField.value = returnDate2(inDay, calDateFormat);
	calDateField_2.value = returnDate2(inDay, calDateFormat)

    // GIVE FOCUS BACK TO THE DATE FIELD
    calDateField_2.focus();

    // CLOSE THE CALENDAR WINDOW
    top.newWin.close()
}

function returnDate2(inDay, calDateFormat)
{
