package portal.com.eje.carpelect.mgr;
...
public class ManagerTrabajador {
	...
	public ConsultaData getTrabajadoresInUnidad(String unidad, Connection Conexion, String empresa, String superNodo) {
		String strPersonas = "";
        ...
        return getTrabajadoresPerfilados(strPersonas, unidad);
	}
	...
	public ConsultaData getTrabajadores(Integer rut, String unidad) {
		...
		strConsulta.append(" 	'' as options, mail, nombre, t.unidad, t.empresa, t.area \n");
	...
	public ConsultaData getTrabajadoresPerfilados(String superNodo, String unidad) {
		StringBuilder strConsulta = new StringBuilder();
		strConsulta.append(" select distinct t.rut,t.digito_ver,t.nombres,t.ape_paterno,t.ape_materno, \n");
		strConsulta.append(" 	convert(varchar,t.fecha_ingreso,106) as fecha_ingreso, \n");
		strConsulta.append(" 	isnull(u.estado,0) as es_encargado, \n");
		strConsulta.append(" 	'' as options, mail, nombre \n");
		strConsulta.append(" from eje_ges_trabajador t \n");
		strConsulta.append(" 	left join eje_ges_unidad_encargado u on u.unid_id = t.unidad and t.rut = u.rut_encargado and u.estado = 1 \n");
		strConsulta.append(" 	left join eje_ges_trabajador_unidad c on t.rut = c.rut \n");
		strConsulta.append(" WHERE	t.rut in ("+ superNodo +") ");
	...
	*/
	...
	public boolean delConfirmacion(int rut) {
		StringBuilder strConsulta = new StringBuilder();
		strConsulta.append(" delete from eje_ges_correo_confirmacion  where rut = ?");
