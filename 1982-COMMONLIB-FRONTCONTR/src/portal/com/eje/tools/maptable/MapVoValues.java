 ...
 * @since 12-04-2019
 * */
public class MapVoValues<T extends Object> {
	private List<T> vos;
	 ...
	 * */
	public MapVoValues(List<T> vos, String[] campos) {
		this.vos = vos;
	 ...
	 * Cuidado!!, es CASE SENITIVE en los nombres de Camos
	 * */
	public MapVoValues(List<T> vos, List<String> campos) {
		this.vos = vos;
	...
	private void buildMaps() {
		...
		for(final T vo : vos) {
			VoTool.getInstance().eachFieldFromVo(vo, new IFieldIterable() {
	...
	public List<Object> getFiltrados(String campo, Object value) {
	 ...
	 * @throws FieldDoesntHaveHash
	 * */
	public List<Object> getFiltradosIn(String campo, List<Object> valores) {
	...
	public static <T>Map<Object, List<T>> groupBy(List<T> vos, String campo) {
		...
		MapVoValues mapPorPeriodo = new MapVoValues(vos, new String[] {campo});
