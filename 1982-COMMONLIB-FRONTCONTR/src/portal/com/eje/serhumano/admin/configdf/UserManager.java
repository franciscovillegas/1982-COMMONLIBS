...
public class UserManager
{
    ...
    public boolean crearUsuario(String rutUsuario, String password)
    {
        ...
        {
            String sql = String.valueOf(String.valueOf((new StringBuilder("INSERT INTO eje_ges_usuario (login_usuario, password_usuario, rut_usuario, error, passw_cambiar, passw_ult_cambio) VALUES ('")).append(rutUsuario).append("', '").append(password).append("', ").append(rutUsuario).append(", 0, 'S', getdate())")));
    ...
    public void quitarRolesComplementarios(String rutUsuario, Vector rolId)
    {
        ...
        String sql = String.valueOf(String.valueOf((new StringBuilder("DELETE FROM eje_ges_usuario_rol WHERE (rut_usuario = ")).append(rutUsuario).append(")")));
        if(!strRoles.equals(""))
    ...
    {
        String sql = String.valueOf(String.valueOf((new StringBuilder("INSERT INTO eje_ges_usuario_rol (rol_id, rut_usuario) VALUES ('")).append(rolId).append("',").append(rutUsuario).append(")")));
        consul.insert(sql);
    }
    ...
    public void quitarAccesos(String rutUsuario, Vector accesosId)
    {
        quitarAccesosRutComplementarios(rutUsuario, accesosId);
        String strAccesos = Tools.creaLista(accesosId, ",", "'");
        boolean anex = false;
        ...
        sql = String.valueOf(String.valueOf((new StringBuilder("DELETE FROM eje_ges_usuario_acceso WHERE (rut_usuario = ")).append(rutUsuario).append(") ")));
        if(!strAccesos.equals(""))
            sql = String.valueOf(String.valueOf((new StringBuilder(String.valueOf(String.valueOf(sql)))).append(" AND (acc_id IN (").append(strAccesos).append("))")));
        OutMessage.OutMessagePrint("--> quitarAccesosComplementarios\n   ".concat(String.valueOf(String.valueOf(sql))));
        consul.insert(sql);
    }
