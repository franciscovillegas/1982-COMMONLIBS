...
public class Periodo
{
    ...
    public String getPeriodoPalabrasSimple()
    {
        String peri_pal = "";
        try
        {
            peri_pal = Tools.RescataMes(Integer.parseInt(mes));
        }
        catch(NumberFormatException e)
        {
            OutMessage.OutMessagePrint("****ERROR EN getPeriodoPalabrasSimple ".concat(String.valueOf(String.valueOf(e.getMessage()))));
        }
        peri_pal = String.valueOf(String.valueOf((new StringBuilder(String.valueOf(String.valueOf(peri_pal)))).append(" ").append(ano)));
        return peri_pal;
    }
