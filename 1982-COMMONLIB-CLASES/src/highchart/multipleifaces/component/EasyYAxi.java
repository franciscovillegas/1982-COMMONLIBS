...
public class EasyYAxi extends JsonObject {
	...
	public EasyYAxi addValor(JsonObject valor) {
		valores.add(valor);
		return this;
	}
	
	public EasyYAxi addValor(Double valor) {
		valores.add(valor);
		return this;
	}
	
	public EasyYAxi addValor(Double valor,Double valor2) {
		valores.add(valor, valor2);
		return this;
	}
	
	public EasyYAxi addValor(Integer valor) {
		valores.add(valor);
		return this;
	}
