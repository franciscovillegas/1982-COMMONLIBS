...
//            OutMessage, ByteArrayDataSource
...
public class enviaCorreo
{
    ...
    public enviaCorreo(String to, String subject, String from, Template template, SimpleHash root, String NameFile)
    {
        ...
        String mailhost = proper.getString("portal.mailhost");
        ...
        try
        {
            ...
            OutMessage.OutMessagePrint("------->MailHost Correo: ".concat(String.valueOf(String.valueOf(mailhost))));
            ...
            Transport.send(msg);
            OutMessage.OutMessagePrint("subject: ".concat(String.valueOf(String.valueOf(subject))));
        }
        catch(Exception e)
        {
            e.printStackTrace();
