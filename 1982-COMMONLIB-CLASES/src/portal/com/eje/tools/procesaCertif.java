...
public class procesaCertif extends MyHttpServlet {

    public procesaCertif()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        if(!user.esValido())
        {
            mensaje.devolverPaginaSinSesion(resp, "Procesando", "Tiempo de Sesi\363n expirado...");
        } else
        {
            ...
            super.retTemplate(resp,"Certificados/procesando.html",modelRoot);
            OutMessage.OutMessagePrint("Fin de doPost");
        }
    }

    public String getServletdatos()
    {
        return "Este servlet genera el formulario de publicaci\363n";
    }
