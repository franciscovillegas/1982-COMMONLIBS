...
//      connMgr.freeConnection("portal", connection);
    ...
    public void PerfilLaboral (HttpServletRequest req, HttpServletResponse resp,Connection connection,String rutOrg) throws IOException, ServletException {
        String periodo = "";
        ...
        String template = "CarpetaElectronica/PerfilLaboral.htm";
    	...
    	SimpleHash liquida = fp.getDatosLiquidacion(connection,getServletContext().getRealPath(getTemplatePath()),periodo,18,rut,null);
    	...
    	super.retTemplate(req, resp,template,contenedor);
