...
public class TraspCertifLiquidaDetalleDescuento extends Proceso
{

    public TraspCertifLiquidaDetalleDescuento(Connection conOrigen, Connection conDestino, String fecha_desde)
    {
    ...
    public boolean Run(int empresa, int periodo)
    {
        ...
        OutMessage.OutMessagePrint("\nActualizando Data Liquidacion de Remuneraciones Descuentos");
        ...
        if(consulAuxx.next())
        {
            ...
            OutMessage.OutMessagePrint("Fin de Traspaso Data Liquidacion de Remuneraciones Descuentos");
        }
        consulAuxx.close();
        return true;
    }
