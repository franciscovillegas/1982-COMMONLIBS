...
public class Organica
{
    ...
    public static void main(String args[])
    {
        ...
        } else
        {
            ...
            OutMessage.OutMessagePrint("sql : " + sql);
            empresas.exec(sql);
        ...
        OutMessage.OutMessagePrint("sql E/U : " + sql);
        consul.exec(sql);
        ...
        while(consul.next()) 
        {
            ...
            if(nodoBuscado != null)
                ...
                OutMessage.OutMessagePrint(" El nodo (E:" + padreEmp + ", U:" + padreUnid + ") no existe");
        }
        consul.close();
        Usuario.SuperNodo = nodoSuperPadre;
