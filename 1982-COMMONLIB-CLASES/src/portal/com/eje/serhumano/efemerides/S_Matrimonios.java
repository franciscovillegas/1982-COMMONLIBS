...
public class S_Matrimonios extends MyHttpServlet
{

    public S_Matrimonios()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        if(Conexion != null && ConSh != null)
        {
            ...
            if(user.esValido())
                ...
                super.mensaje.devolverPaginaSinSesion(resp, "Matrimonios", "Tiempo de Sesi\363n expirado...");
            insTracking(req, "Matrimonio".intern(), null);
        } else
        {
        ...
        throws ServletException, IOException
    {
        ...
        consul = (new Efemerides_Manager(conSh)).getMatrimonios(mes, ano);
        modelRoot.put("detalle", consul.getSimpleList());
        consul.close();
        super.retTemplate(resp,"efemerides/matrimonios.htm",modelRoot);
