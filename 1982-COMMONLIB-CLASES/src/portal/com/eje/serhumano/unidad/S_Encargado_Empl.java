...
public class S_Encargado_Empl extends MyHttpServlet
{

    public S_Encargado_Empl()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        modelRoot.put("glosa_empresa", userRut.EmpresaDescrip);
        ...
        super.retTemplate(resp,"mapa/dotacion_unidad.htm",modelRoot);
