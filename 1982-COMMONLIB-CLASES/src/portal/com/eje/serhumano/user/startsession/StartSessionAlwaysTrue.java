...
/**
 * Clase cuyo fin es la de siempre estar logeado, siempre retornará true al ser logeado.
 * */
public class StartSessionAlwaysTrue extends AbsClaseWebInsegura {

	public StartSessionAlwaysTrue(IOClaseWeb ioClaseWeb) {
		super(ioClaseWeb);
