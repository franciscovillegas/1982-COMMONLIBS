...
public class EjecutaBusquedaAlfabetica
{

    public EjecutaBusquedaAlfabetica(Connection Conexion, String Query)
    {
    ...
    public SimpleList EjecutaBusquedaAlfabetica(Connection Conexion, String Query)
    {
