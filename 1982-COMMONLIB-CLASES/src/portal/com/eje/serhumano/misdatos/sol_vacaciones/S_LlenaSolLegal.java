...
// Source File Name:   S_LlenaSolLegal.java
...
public class S_LlenaSolLegal extends MyHttpServlet
{

    public S_LlenaSolLegal()
    {
    }
        ...
        throws IOException, ServletException
    {
        ...
        String template = "misdatos/sol_vacaciones/sol_feriado_legal.htm";
        ...
        {
            insTracking( req, "Sol. Legal", null);
