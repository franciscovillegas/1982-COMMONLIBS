...
public class ArmaQueryBusquedaAlfabetica
{
    ...
    public ArmaQueryBusquedaAlfabetica(HttpServletRequest req)
    {
        ...
        if(req.getParameter("cargo") != null && !req.getParameter("cargo").trim().equals("") && !req.getParameter("cargo").trim().equals("Todas"))
            Bus2 = String.valueOf(String.valueOf((new StringBuilder(" AND cargo_id ='")).append(req.getParameter("cargo").toUpperCase()).append("' ").append(Bus2)));
        String sel1 = "";
        String sel2 = "";
        String sel3 = "";
        String sel4 = "";
