  function AbrirSolicitudVaca() {
	...
	ventmsg2 = open(url2, "solvaca", "scrollbars=yes,width=700,height=510,left=5,top=5");
  }
...
function AbrirCartolaVaca() {
	...
	ventmsg2 = open(url2, "cartolavaca", "scrollbars=yes,width=700,height=510,left=5,top=5");
}
...
function AbrirFormPermisos() {
	...
	ventmsg2 = open(url2, "permisos", "scrollbars=yes,width=700,height=500,left=5,top=5");
}
...
function openCambiarClave(regla){
	var url = "../servlet/CambiarClave?regla="+regla;
