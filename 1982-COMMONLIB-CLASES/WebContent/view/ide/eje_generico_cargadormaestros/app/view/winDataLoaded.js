                        ...
                        },
                        {
                            ...
                            renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                ...
                                if(record.get("estado") == 0) {
                                    /*PENDIENTE CARGA*/
                                    this.items[0].icon 	  = '../../images/btns/time.ico';
                                    this.items[0].tooltip = 'Pendiente por importar';
                                }
                                else if(record.get("estado") == 5) {
                                    this.items[0].icon 	  = '../../images/btns/tick.ico';
                                    this.items[0].tooltip = 'Importación correctamente cargada.';

                                }
                                else if(record.get("estado") == 11) {
                                    this.items[0].icon 	  = '../../images/btns/cross.ico';
                                    this.items[0].tooltip = 'Con errores';
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            xtype: 'button',
                            handler: function(button, e) {
                                Ext.getCmp("winDataLoaded").destroy();
                            },
