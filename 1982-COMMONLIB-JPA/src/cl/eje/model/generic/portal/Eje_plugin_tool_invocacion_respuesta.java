...
@TableDefinition(jndi = "portal", pks = { @PrimaryKeyDefinition(autoIncremental = true, field = "id_respuesta", isForeignKey = false, numerica = true) }, tableName = "eje_plugin_tool_invocacion_respuesta")
public class Eje_plugin_tool_invocacion_respuesta extends Vo {
