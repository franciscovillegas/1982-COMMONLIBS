...
@TableDefinition(jndi = "portal", pks = { @PrimaryKeyDefinition(autoIncremental = true, field = "id_error", isForeignKey = false, numerica = true) }, tableName = "Eje_plugin_tool_invocacion_error")
public class Eje_plugin_tool_invocacion_error extends Vo {
